...
function create_uniform_cluster(center::Array{Float64, 1}, perturbation::Float64, num_points::Int64)
  ...
  random_perturbations = (rand(Float64, num_points, size(center, 1), ) .- 0.5) * 2
